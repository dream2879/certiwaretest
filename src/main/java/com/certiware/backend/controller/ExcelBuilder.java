...
//	public ExcelBuilder(List<SelectProgressListResModel> selectProgressListResModels){
//		
//		this.selectProgressListResModels = selectProgressListResModels;		
//	}
	...
	protected void buildExcelDocument(Map<String, Object> arg0, HSSFWorkbook arg1, HttpServletRequest arg2,
		...
		System.out.println("start ExcelBuilder");
		
		String fileName = "excel.xls";
		 
		arg3.setHeader("Content-Disposition", "attachement; filename=\""+ java.net.URLEncoder.encode(fileName, "UTF-8") + "\";charset=\"UTF-8\"");
...
//			cal1.setTime(selectProgressListReqModel.getStartDate());			
//			
//			// 정보 조회
...
//			String projectYear = String.valueOf(cal1.get(cal1.YEAR));
			...
			objCell0_1.setCellValue("투입인력/순매출액 현황");
...
//				System.out.print(selectProgressListResModel.getProjectName()+"/"+selectProgressListResModel.getManpowerName()+"/");
			...
			// 파일 다운로드 처리
			//File xlsFile = new File("E:/testExcel.xls");            
	...
	System.out.println("end ExcelBuilder");
