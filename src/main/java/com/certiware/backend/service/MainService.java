...
public class MainService {
	 ...
	 */
	@Transactional
	public SelectDashboardResModel selectDashboard(SelectDashboardReqModel dashboardReqModel, SelectDashboardResModel selectDashboardResModel) throws Exception{
		
		// 프로젝트 갯수 통계 정보 조회
		selectDashboardResModel.setProjectStatisticsModel(mainMapper.selectProjectStatistics(dashboardReqModel));
		
		// 프로젝트 인원 통계 정보 조회
		selectDashboardResModel.setManpowerStatisticsModel(mainMapper.selectManpowerStatistics(dashboardReqModel));
		
		// 프로젝트 매출 통계정보 조회
		selectDashboardResModel.setManpowerMMStatisticsModel(mainMapper.selectManpowerMMStatistics(dashboardReqModel));
